...
Rationality is the art of thinking in ways that result in [[World modeling|accurate beliefs]] and [[Decision Theory|good decisions]]. It is the primary topic of LessWrong.Rationality is not only about avoiding the vices of [[Self-Deception|self-deception]] and obfuscation (the failure to [[Conversation|communicate clearly]]), but also about the virtue of [[Curiosity|curiosity]], seeing the world more clearly than before, and [[Ambition|achieving things]][[Skill Building|previously unreachable]][[Coordination & Cooperation|to you]]. The study of rationality on LessWrong includes a theoretical understanding of ideal cognitive algorithms, as well as building a practice that uses these idealized algorithms to inform [[Heuristics & Biases|heuristics]],[[Habits|habits]], and [[Techniques|techniques]], to successfully reason and make decisions in the real world.

Topics covered in rationality include (but are not limited to): normative and theoretical explorations of [[Solomonoff Induction|ideal]][[Probability & Statistics|reasoning]]; the [[Evolutionary Psychology|capabilities and limitations]][[Neuroscience|of our brain]],[[Dual Process Theory (System 1 & 2)|mind and psychology]]; applied advice such as [[Introspection|introspection]] techniques and [[Group Rationality|how to achieve truth collaboratively]]; practical techniques and methodologies for figuring out what’s true ranging from rough quantitative modeling to full research guides.

Note that content about *how the world is *can be found under [[World modeling|World Modeling]], and practical advice about *how to change the world* is categorized under [[World optimization|World Optimization]] or [Practical](/tag/practical).
...
Similarly, most object-level material about *how the world is*, e.g. math, biology, history, etc. is tagged under [[World modeling|World Modeling]] tag, with exceptions for neuroscience and probability theory, etc., which have concrete consequences for how one ought to think.
...
---
tags: [UP, LessWrong, Discipline, Concept]
aliases: [Reason, Logos]
---

> The quality of thinking well, wielding intelligence in such a way as to maximize the convergence between its beliefs and reality, and acts on these beliefs in such a manner as to maximize its chances of achieving whatever goals it has.
...
1. **[[Epistemic rationality]]**: systematically improving the accuracy of your beliefs. The pursuit of [[Truth]]
...
## Contrast **experience** and **expertise**:

- **Expertise**: "develop[ing] a schematic principle that involves conceptual understanding of the problem"

We want expertise in "rationality," as Yudkowsky puts it: "**the martial art of the mind.**" It's harder to train because it's less tangible, but we've made a lot of recent progress:

1. Heuristics & [[Heuristics & cognitive biases]] program in experimental psychology
2. [[Bayesianism]]
3. [[Evolutionary Psychology]] & Social psychology

"Your strength as a rationalist is your ability to be more confused by fiction than by reality. If you are equally good at explaining any outcome, you have zero knowledge." ([Source](https://www.lesswrong.com/s/zpCiuR4T343j9WkcK/p/5JDkW4MYXit2CquLs))

# [[Map and Territory]]

- [[Beware your biases|Predictably wrong]]
- [[Belief|Fake beliefs]]: what makes a belief a "map"
- [[Uncertainty|Noticing confusion]]: how our brains work in practice
- Mysterious Answers: unification
- The simple truth

## [[Change your mind|How to Actually Change Your Mind]]

- Overly Convenient Excuses
- [[Politics]]
- Against [[Rationalization]]
- Against [[Doublethink]]
- Seeing with Fresh Eyes (40 pgs)
- Death Spirals (70 pgs)
- Letting Go (40 pgs)
...
- A human's guide to words (120 pgs)
...
- Lawful truth (50 pgs)
- Reductionism 101 (40 pgs)
- Joy in the merely real (50 pgs)
- Physicalism 201 (120 pgs)
- Quantum physics and many worlds (120 pgs)
- Science & rationality (150 pgs)

= 530 pgs

## Mere Goodness

- Fake preferences (40 pgs)
- Value theory (100 pgs)
- Quantified humanism (80 pgs)

= 220 pgs

## Becoming Stronger

- Yudkowsky's coming of age (80 pgs)
- Challenging the difficult (40 pgs)
- The craft and the community (120 pgs)
