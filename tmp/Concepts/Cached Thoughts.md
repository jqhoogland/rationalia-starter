...
href: https://www.lesswrong.com/tag/cached-thought
---
...
*See also*: [[Groupthink]], [[Information Cascades]], [[Status Quo Bias|Status quo bias]], [[Semantic Stopsign]], [[Bad title|Separate Magisteria]]

Cached thoughts can be useful in saving computational resources at the cost of some memory load, and also at the risk of maintaining a belief long past the point when evidence should force an update. In particular, cached thoughts can result in a lack of creative approaches to problem-solving, as cached solutions may interfere with the formation of novel ones. What is generally called [[Common Sense|common sense]] is more or less a collection of cached thoughts....[(Read More)]()
