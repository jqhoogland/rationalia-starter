...
---
tags: [UP, Concept]
href: https://www.britannica.com/science/probability-theory
---

> A branch of mathematics concerned with the analysis of random (==or *uncertain*==) phenomena. 
...
1. Probability is non-negative: $P(X) > 0$ 
2. Choice of upper bound: Certainty <=> $P(X) = 1$.
3. Composition rule: Probability of union of mutually exclusive events goes as sum
	1. Corollary: Joint probability of independent events goes as multiplication

### Common distributions
- **Lognormal**: shows up when two independent random positive variables are multiplies.


### Causal graphs
- **Screening off**
- **D-separation**: knowing a given node in a path isolates your knowledge of nodes at either side.
	- To this end we seek **closeness-to-the-issue**. [[Information inequality]]
