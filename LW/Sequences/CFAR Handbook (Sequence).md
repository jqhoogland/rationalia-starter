...
- [[Trigger-Action Planning (Post)]] (`= [[Trigger-Action Planning]].status`)
- [[LW/Concepts/Rationality/Techniques/Goal Factoring]] (`= [[Goal Factoring]].status`)
...
- [[Internal Double Crux (Post)]] (`= [[Internal Double Crux]].status`)
