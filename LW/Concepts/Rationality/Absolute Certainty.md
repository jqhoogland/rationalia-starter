...
The impossibility of justified absolute certainty is sometimes used as a [[Rationalization (Post)|rationalization]] for the [[Fallacy of Gray|fallacy of gray]].
...
- [[LW/Concepts/Rationality/Failure Modes/Mind Projection Fallacy|Mind projection fallacy]] (`= [[Mind Projection Fallacy|Mind projection fallacy]].status`)
- [[Doubt]] (`= [[Doubt]].status`)
