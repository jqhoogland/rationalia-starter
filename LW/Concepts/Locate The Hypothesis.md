...
href: https://lesswrong.com/tags/locate-the-hypothesis
type: tag
tags:
  - LessWrong
  - Concept
...
When the space of possible answers is large, it takes a large [[Amount of Evidence|amount of evidence]] just to _think_ of the correct answer - to _promote it to your attention_.
...
When the space of possibilities is large, it takes a [large amount](https://www.lesswrong.com/tag/amount-of-evidence) of [[Evidence|Bayesian evidence]] just to _locate_ the truth in hypothesis-space - to raise it to the level of our attention - to select it as one of a manageable number of alternatives to spend time thinking about individually.
