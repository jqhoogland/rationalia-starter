---
tags: ['UP', 'LessWrong', 'Portal', 'Concept']
href:
- https://www.lesswrong.com/tag/utility
...
-[[1 Projects/Learning/Rationalism/Concepts/Expected Utility|Expected utility]]
...
> A term in economics that is used to model worth or value .

**2 types**:

1. Utility as in [[Decision Theory]] to represent a single agents preference.
2. Utility as in [[Utilitarianism]] to represent cross-agent welfare in an ethical sense.
