...
Back: An AI design that chooses options from a distribution of human-like actions (or weights actions by likelihood that humans would do them) rather than global maximization.
Tags: LessWrong
END
