/**
 * Compiled from:
 * - [CFAR Jargon Appendix](https://www.forum.effectivealtruism.org/posts/fbv9FWss6ScDMJiAx/appendix-jargon-dictionary).
 * - [LW "Jargon" tag](https://www.forum.effectivealtruism.org/tag/lesswrong-jargon)
 */
...
const loadCAFRJargon = async () => {
    ...
    return request('https://www.forum.effectivealtruism.org/graphql', query)
